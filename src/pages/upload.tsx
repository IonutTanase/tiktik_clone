...
const Upload = () => {
  ...
  return (
    <div className="flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F] justify-center">
                ...
                {videoAsset ? (
                  <div>
                    <video
                      ...
                      loop
                      controls
                      className="rounded-xl h-[450px] mt-16 bg-blac"
                    ></video>
                  </div>
                ) : (
